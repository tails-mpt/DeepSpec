...
# The dense Qwen3-style DSpark draft is synthesized from the target dims by
...
exp_name = "dspark_block7_nemotron3_nano_v2"
seed = 42
...
model = dict(
    ...
    # Nemotron vocab (0..131071), used as the DSpark noise/mask token.
    mask_token_id=999,
    num_anchors=512,
