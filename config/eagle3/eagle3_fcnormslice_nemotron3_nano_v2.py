...
#
# EAGLE-3.1 "FC-norm" PER-SLICE ABLATION: identical to eagle3_nemotron3_nano_v2
# except fc_norm_perslice=True -- RMSNorm each of the 5 hidden_size source slices
# INDEPENDENTLY (register alignment) before the fusion linear (self.fc), rather
# than one norm over the full 5*hidden concat (that is the fc_norm variant).
# Single-variable ablation against the v2 baseline; distinct exp_name so it lands
# in its own checkpoint dir.
NEMOTRON3_NANO = "/mnt/persistent/models/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16"

project_name = "deepspec"
exp_name = "eagle3_fcnormslice_nemotron3_nano_v2"
seed = 0
