...
# SINGLE-VARIABLE LEVER: weight_decay 0.0 -> 0.1 (everything else identical to
# eagle3_nemotron3_nano_v2.py, incl ttt_length=7). Motivation: the v2 heads
# plateau at mean tau ~2.88 across 3 draft architectures; regularization may
# improve generalization on the harder/OOD chat domain (mt-bench ~2.2) without
# hurting gsm8k. Orthogonal to the ttt9 horizon lever and H200's data-scale bet. [2026-07-21]
NEMOTRON3_NANO = "/mnt/persistent/models/NVIDIA-Nemotron-3-Nano-30B-A3B-BF16"

project_name = "deepspec"
exp_name = "eagle3_wd01_nemotron3_nano_v2"
seed = 0
